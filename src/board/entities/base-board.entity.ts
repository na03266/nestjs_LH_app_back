...
export class BaseBoard {
    ...
    @Column('set', {name: 'wr_option', enum: ['html1', 'html2', 'secret', 'mail']})
    wrOption: string;
    ...
    @Column('varchar', {name: 'wr_facebook_user', length: 255, default: ''})
    wrFacebookUser: string;

    @Column('varchar', {name: 'wr_twitter_user', length: 255, default: ''})
    wrTwitterUser: string;

    @Column('varchar', {name: 'wr_1', length: 255, default: ''})
    wr1: string;

    @Column('varchar', {name: 'wr_2', length: 255, default: ''})
    wr2: string;

    @Column('varchar', {name: 'wr_3', length: 255, default: ''})
    wr3: string;

    @Column('varchar', {name: 'wr_4', length: 255, default: ''})
    wr4: string;

    @Column('varchar', {name: 'wr_5', length: 255, default: ''})
    wr5: string;

    @Column('varchar', {name: 'wr_6', length: 255, default: ''})
    wr6: string;

    @Column('varchar', {name: 'wr_7', length: 255, default: ''})
    wr7: string;

    @Column('varchar', {name: 'wr_8', length: 255, default: ''})
    wr8: string;

    @Column('varchar', {name: 'wr_9', length: 255, default: ''})
    wr9: string;

    @Column('varchar', {name: 'wr_10', length: 255, default: ''})
    wr10: string;
}
